...
\textbf{We select intervals in the magnetosphere based on} CIS HIA omnidirectional ion flux spectrum. \textbf{Magnetosphere is defined by the disappearance of hot magnetosheath ion population.} The plasma density decreases toward zero, the magnetic field strength \textbf{becomes} large. We \textbf{eliminated} 15--30\,min after/before the magnetopause transition to identify magnetosphere intervals. This way we found 132 intervals \textbf{of which we found 132} (Table~\ref{tab:msph}) using Cluster SC3 measurements.  Cluster SC3 spends considerable time in the magnetosphere (Figure~\ref{fig:msphorbit}). 
