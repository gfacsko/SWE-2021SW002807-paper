...
\authors{G.~Facsk{\'o}\affil{1,2,3}, D.~G.~Sibeck\affil{2}, I.~Honkonen\affil{4}, L.~Degener\affil{4}\thanks{Now private individual, Hannover, Germany}, P.~Peitso\affil{5}\thanks{Now at Aurora Propulsion Technologies, Espoo, Finland }, E.~I.~Tanskanen\affil{5}, C.~R.~Anekallu\affil{6}, J.~Kalm{\'a}r\affil{7}, J.~B{\'o}r\affil{7}, G.~Farinas~Perez\affil{2,3}\thanks{Now at University of Miami, Electrical and Computer Engenieering Department, Miami, Florida, USA}, S.~Szalai\affil{7}, {\'A.}~Kis\affil{7}, V.~Wesztergom\affil{7}}%, Y.~Y.~Shprits\affil{8,9}, N.~A.~Aseev\affil{8,9}
